...
import { AtSearchBar, AtGrid, AtTabs, AtTabsPane, AtList, AtListItem, AtCurtain } from 'taro-ui'
...
function Index () {
  ...
  const { statusBarHeight, appHeaderHeight, titelBarWidth, titleBarHeight, marginSides } = UseNavInfo();
